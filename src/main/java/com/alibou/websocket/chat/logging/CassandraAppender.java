...
// @Plugin(name = "CassandraAppender", category = "Core", elementType =
...
// // Constructor
// public CassandraAppender(String name, Layout<? extends Serializable> layout,
// CqlSession session,
// String insertQuery) {
